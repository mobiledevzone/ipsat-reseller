...
<p class="text-red"><strong><?php echo e(__('Default User Created')); ?> : <?php echo e(__('admin@example.com')); ?> / <?php echo e(__('admin')); ?></strong></p>
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/ipsat_reseller/resources/views/vendor/installer/finished.blade.php ENDPATH**/ ?>