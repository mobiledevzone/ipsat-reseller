    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>">
            ...
            <div id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('domain') ? ' has-error ' : ''); ?>">
                    <label for="domain">
                        <?php echo e(__('Domain Name')); ?>

                    </label>
                    <input type="text" name="domain" id="domain" value=""
                        placeholder="<?php echo e(__('Domain Name')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/ipsat_reseller/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>